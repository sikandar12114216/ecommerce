              ...
              <div class="aa-cartbox">
               ...
               <?php if($totalCartItem>0): ?>
                  ...
                  <ul>
                    ...
                    ?>
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="<?php echo e(asset('storage/media/'.$cartItem->image)); ?>" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#"><?php echo e($cartItem->name); ?></a></h4>
                        <p><?php echo e($cartItem->qty); ?> * Rs <?php echo e($cartItem->price); ?></p>
                      </div>
                    </li>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <div id="popup_login">
            ...
            <form class="aa-login-form" id="frmLogin">
              ...
              <input type="email" placeholder="Email" name="str_login_email" required value="<?php echo e($login_email); ?>">
              <label for="">Password<span>*</span></label>
              <input type="password" placeholder="Password" name="str_login_password" required value="<?php echo e($login_pwd); ?>">
...
</html><?php /**PATH D:\laravel\ecom\my_ecom\resources\views/front/layout.blade.php ENDPATH**/ ?>